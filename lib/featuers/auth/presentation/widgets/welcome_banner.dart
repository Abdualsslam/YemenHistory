  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text(AppStrings.appName, style: CustomTextStyles.pacifico700style32),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            crossAxisAlignment: CrossAxisAlignment.end,
            children: [SvgPicture.asset(Assets.imagesVector1), SvgPicture.asset(Assets.imagesVector2)],
          ),
        ],
      ),
    );
